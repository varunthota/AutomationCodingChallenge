...
### Techonology
 Developed in Cypress

 ### Test Feature
searchValidations.feature - Validation of search function with valid and invalid github user
#### Test Scenarios
- Verify the user search shows up the repositories and respective description details
- Verify the flow with the invalid user

#### Script - package.json
-  "chromeHeadless": "npx cypress run --spec \"/**/*.feature\" --browser chrome --headless"
#### Command to run in chrome headless
